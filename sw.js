const CACHE_NAME = 'viscora-cache-v368';
const ASSETS = [
  './',
  './index.html',
  './index.css?v=v368',
  ...
  './js/level.js?v=v368',
  './js/player.js?v=v368',
  './js/enemies.js?v=v368',
  './js/viscosity.js?v=v368',
  './js/boss.js?v=v368',
  './js/editor.js?v=v368',
  './js/controls_customizer.js?v=v368',
  './js/cloud_save.js?v=v368',
  './js/generator.js?v=v368',
  './js/shop.js?v=v368',
  './nasil-oynanir.html?v=v368',
  './guncellemeler.html?v=v368',
  './hakkinda.html?v=v368',
  './privacy.html?v=v368',
  './terms.html?v=v368',
  './ads.txt',
  './app-ads.txt',
  './assets/audio/menu_theme.mp3?v=v368',
  './assets/audio/game_theme.mp3?v=v368',

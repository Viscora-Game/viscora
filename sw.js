const CACHE_NAME = 'viscora-cache-v367';
const ASSETS = [
  './',
  './index.html',
  './index.css?v=v367',
  ...
  './js/level.js?v=v367',
  './js/player.js?v=v367',
  './js/enemies.js?v=v367',
  './js/viscosity.js?v=v367',
  './js/boss.js?v=v367',
  './js/editor.js?v=v367',
  './js/controls_customizer.js?v=v367',
  './js/cloud_save.js?v=v367',
  './js/generator.js?v=v367',
  './js/shop.js?v=v367',
  './nasil-oynanir.html?v=v367',
  './guncellemeler.html?v=v367',
  './hakkinda.html?v=v367',
  './privacy.html?v=v367',
  './terms.html?v=v367',
  './assets/audio/menu_theme.mp3?v=v367',
  './assets/audio/game_theme.mp3?v=v367',

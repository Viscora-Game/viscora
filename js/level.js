import { audio } from './audio.js?v=v281';
import { THEMES } from './generator.js?v=v281';
...
export class Level {
    ...
    "arrowShooters": []
            ...
            data = {
                ...
                "platforms": [
                    { "x": 0, "y": 630, "w": 400, "h": 140, "type": "normal" },
                    { "x": 700, "y": 570, "w": 240, "h": 80, "type": "normal" },
                    { "x": 1260, "y": 500, "w": 120, "h": 40, "type": "normal" },
                    { "x": 1600, "y": 300, "w": 60, "h": 120, "type": "sticky" },
                    { "x": 1860, "y": 260, "w": 840, "h": 40, "type": "normal" },
                    { "x": 3450, "y": 260, "w": 240, "h": 40, "type": "normal" },
                    { "x": 3210, "y": 100, "w": 60, "h": 20, "type": "normal" },
                    { "x": 3890, "y": 150, "w": 800, "h": 40, "type": "normal" },
                    { "x": 4120, "y": -210, "w": 60, "h": 20, "type": "normal" },
                    { "x": 4530, "y": -200, "w": 60, "h": 20, "type": "normal" }
                ],
                "spikes": [
                    { "x": 2060, "y": 240, "w": 60, "h": 20, "direction": "up" },
                    { "x": 2510, "y": 240, "w": 60, "h": 20, "direction": "up" },
                    { "x": 760, "y": 550, "w": 60, "h": 20, "direction": "up" },
                    { "x": 820, "y": 550, "w": 60, "h": 20, "direction": "up" },
                    { "x": 4120, "y": -190, "w": 60, "h": 20, "direction": "down" },
                    { "x": 4530, "y": -180, "w": 60, "h": 20, "direction": "down" },
                    { "x": 4000, "y": 130, "w": 60, "h": 20, "direction": "up" },
                    { "x": 4440, "y": 130, "w": 60, "h": 20, "direction": "up" }
                ],
                "enemies": [
                    { "x": 1500, "y": 380, "rangeX": 120, "speed": 1.2, "isVertical": true, "color": "#06b6d4", "type": "patrol" },
                    { "x": 1170, "y": 460, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 1110, "y": 110, "rangeX": 150, "speed": 1.2, "isVertical": false, "color": "#06b6d4", "type": "sweeper_ufo" },
                    { "x": 540, "y": 500, "rangeX": 120, "speed": 1.2, "isVertical": true, "color": "#06b6d4", "type": "patrol" },
                    { "x": 2170, "y": -90, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 2310, "y": -180, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 2550, "y": -240, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 2180, "y": 210, "rangeX": 120, "speed": 1.2, "isVertical": false, "color": "#f43f5e", "type": "patrol" },
                    { "x": 2460, "y": 210, "rangeX": 120, "speed": 1.2, "isVertical": false, "color": "#f43f5e", "type": "patrol" },
                    { "x": 3570, "y": 240, "rangeX": 110, "speed": 1, "isVertical": false, "color": "#10b981", "type": "chaser" },
                    { "x": 4020, "y": -320, "rangeX": 150, "speed": 1.2, "isVertical": false, "color": "#06b6d4", "type": "sweeper_ufo" },
                    { "x": 4470, "y": -320, "rangeX": 150, "speed": 1.2, "isVertical": false, "color": "#06b6d4", "type": "sweeper_ufo" },
                    { "x": 4310, "y": 120, "rangeX": 120, "speed": 1.2, "isVertical": false, "color": "#f43f5e", "type": "patrol" },
                    { "x": 4160, "y": -20, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 4430, "y": -90, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 3570, "y": 140, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 3660, "y": 80, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 3490, "y": 30, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 1440, "y": 180, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" }
                ],
                "bouncePads": [
                    { "x": 2640, "y": 240, "w": 50, "h": 20, "force": 12 }
                ],
                "flamethrowers": [
                    {
                        "id": 9209,
                ...
                "fallingBlockTraps": [
                    { "startX": 1970, "startY": -40, "x": 1970, "y": -40, "w": 60, "h": 60, "state": "idle", "vy": 0, "timer": 0 },
                    { "startX": 2290, "startY": -40, "x": 2290, "y": -40, "w": 60, "h": 60, "state": "idle", "vy": 0, "timer": 0 },
                    { "startX": 2540, "startY": -180, "x": 2540, "y": -180, "w": 60, "h": 60, "state": "idle", "vy": 0, "timer": 0 }
                ],
                "arrowShooters": [
                    { "x": 580, "y": 280, "w": 48, "h": 48, "dir": "target", "detectionRadius": 400, "fireInterval": 2.5, "arrowSpeed": 4.5, "arrowRange": 400 },
                    { "x": 3050, "y": 390, "w": 48, "h": 48, "dir": "target", "detectionRadius": 400, "fireInterval": 0.75, "arrowSpeed": 9, "arrowRange": 400 }
                ],
                "crystals": [
                    { "x": 820, "y": 530 },
                    { "x": 2280, "y": 220 },
            ...
            data = {
                "serverLevelId": "map_1782595731286_755",
                "name": "LAZER KAFESİ",
                "tags": [],
                "themeId": "neon_sewer",
                "levelWidth": 2200,
                ...
                "platforms": [
                    { "x": -20, "y": 620, "w": 2200, "h": 140, "type": "normal" },
                    { "x": 2070, "y": 350, "w": 40, "h": 120, "type": "normal" },
                    { "x": 1010, "y": 370, "w": 60, "h": 20, "type": "normal" },
                    { "x": 730, "y": 490, "w": 60, "h": 20, "type": "normal" },
                    { "x": 0, "y": 30, "w": 60, "h": 20, "type": "normal" },
                    { "x": 280, "y": 200, "w": 60, "h": 20, "type": "normal" },
                    { "x": 410, "y": 370, "w": 60, "h": 20, "type": "normal" },
                    { "x": 1150, "y": 310, "w": 60, "h": 20, "type": "normal" },
                    { "x": 1300, "y": 240, "w": 60, "h": 20, "type": "normal" },
                    { "x": 1600, "y": 100, "w": 60, "h": 20, "type": "normal" },
                    { "x": 1720, "y": 330, "w": 60, "h": 20, "type": "normal" },
                    { "x": 60, "y": -70, "w": 40, "h": 120, "type": "normal" },
                    { "x": 1880, "y": 410, "w": 60, "h": 20, "type": "normal" }
                ],
                "spikes": [],
                "acidPools": [],
                "lasers": [],
                "netGates": [],
                "movingPlatforms": [
                    { "startX": 1300, "startY": 410, "targetX": 1450, "targetY": 410, "w": 100, "h": 20, "speed": 0.015 },
                    { "startX": 970, "startY": 210, "targetX": 1120, "targetY": 210, "w": 100, "h": 20, "speed": 0.015 }
                ],
                "crystals": [
                    { "x": 440, "y": 330, "color": "#eab308" },
                    { "x": 310, "y": 160, "color": "#eab308" },
                    { "x": 1030, "y": 330, "color": "#06b6d4" },
                    { "x": 1170, "y": 270, "color": "#06b6d4" },
                    { "x": 1010, "y": 170, "color": "#06b6d4" },
                    { "x": 1350, "y": 380, "color": "#d946ef" },
                    { "x": 1630, "y": 70, "color": "#10b981" },
                    { "x": 1750, "y": 290, "color": "#10b981" },
                    { "x": 1910, "y": 370, "color": "#d946ef" }
                ],
                "enemies": [],
                "pressurePlates": [],
                "pushBlocks": [],
                ...
                "fallingPlatforms": [],
                "breakablePlatforms": [
                    { "x": 190, "y": 480, "w": 120, "h": 40, "type": "platform", "broken": false, "timer": 0, "triggered": false }
                ],
                "hiddenPassages": [],
                "fallingBlockTraps": [],
                "vantuzPoints": [],
                "decorations": [],
                "laserEmitters": [
                    { "x": 0, "y": 540, "w": 40, "h": 40, "direction": 0, "color": "yellow" },
                    { "x": 0, "y": 400, "w": 40, "h": 40, "direction": 0, "color": "blue" },
                    { "x": 0, "y": 250, "w": 40, "h": 40, "direction": 0, "color": "green" },
                    { "x": 0, "y": 110, "w": 40, "h": 40, "direction": 0, "color": "pink" },
                    { "x": 0, "y": 520, "w": 40, "h": 40, "direction": 0, "color": "yellow" },
                    { "x": 0, "y": 560, "w": 40, "h": 40, "direction": 0, "color": "yellow" },
                    { "x": 0, "y": 580, "w": 40, "h": 40, "direction": 0, "color": "yellow" }
                ],
                "laserReceivers": [],
                "staticMirrors": [
                    { "x": 1090, "y": 110, "w": 40, "h": 40, "mirrorType": "bottom-right" },
                    { "x": 1520, "y": -50, "w": 40, "h": 40, "mirrorType": "top-right" },
                    { "x": 1080, "y": -50, "w": 40, "h": 40, "mirrorType": "top-left" },
                    { "x": 1520, "y": 160, "w": 40, "h": 40, "mirrorType": "bottom-left" },
                    { "x": 790, "y": 160, "w": 40, "h": 40, "mirrorType": "top-right" },
                    { "x": 580, "y": 160, "w": 40, "h": 40, "mirrorType": "top-left" },
                    { "x": 580, "y": 240, "w": 40, "h": 40, "mirrorType": "bottom-right" },
                    { "x": 790, "y": 250, "w": 40, "h": 40, "mirrorType": "bottom-left" },
                    { "x": 610, "y": 360, "w": 40, "h": 40, "mirrorType": "top-left" },
                    { "x": 610, "y": 400, "w": 40, "h": 40, "mirrorType": "bottom-right" },
                    { "x": 880, "y": 360, "w": 40, "h": 40, "mirrorType": "top-right" },
                    { "x": 870, "y": 450, "w": 40, "h": 40, "mirrorType": "bottom-left" }
                ],
                "arrowShooters": []
            };
            ...
            data = {
                ...
                "platforms": [
                    { "x": 0, "y": 720, "w": 400, "h": 140, "type": "normal" },
                    { "x": 720, "y": 510, "w": 40, "h": 120, "type": "sticky" },
                    { "x": 620, "y": 720, "w": 120, "h": 40, "type": "normal" },
                    { "x": 560, "y": 280, "w": 240, "h": 40, "type": "normal" },
                    { "x": 1430, "y": 720, "w": 60, "h": 20, "type": "normal" },
                    { "x": 1580, "y": 720, "w": 60, "h": 20, "type": "normal" },
                    { "x": 2270, "y": 590, "w": 600, "h": 40, "type": "normal" },
                    { "x": 2530, "y": 320, "w": 240, "h": 40, "type": "normal" },
                    { "x": 2790, "y": 20, "w": 60, "h": 20, "type": "normal" },
                    { "x": 3190, "y": 710, "w": 240, "h": 40, "type": "normal" },
                    { "x": 3690, "y": 550, "w": 80, "h": 20, "type": "normal" },
                    { "x": 3980, "y": 550, "w": 80, "h": 20, "type": "normal" },
                    { "x": 4230, "y": 550, "w": 80, "h": 20, "type": "normal" },
                    { "x": 3650, "y": 770, "w": 745, "h": 40, "type": "normal" },
                    { "x": 4310, "y": 90, "w": 40, "h": 650, "type": "sticky" },
                    { "x": 3820, "y": 90, "w": 450, "h": 40, "type": "normal" },
                    { "x": 3600, "y": 40, "w": 60, "h": 20, "type": "normal" },
                    { "x": 3420, "y": -80, "w": 60, "h": 20, "type": "normal" },
                    { "x": 3220, "y": -230, "w": 60, "h": 20, "type": "normal" },
                    { "x": 2300, "y": -300, "w": 800, "h": 40, "type": "normal" },
                    { "x": 550, "y": -520, "w": 3000, "h": 40, "type": "normal" },
                    { "x": 1760, "y": -30, "w": 240, "h": 40, "type": "normal" },
                    { "x": 1760, "y": -150, "w": 40, "h": 120, "type": "normal" },
                    { "x": 1760, "y": -190, "w": 240, "h": 40, "type": "normal" },
                    { "x": 2030, "y": -20, "w": 60, "h": 20, "type": "normal" }
                ],
                "spikes": [
                    { "x": 300, "y": 700, "w": 60, "h": 20, "direction": "up" },
                    { "x": 200, "y": 700, "w": 60, "h": 20, "direction": "up" },
                    { "x": 100, "y": 700, "w": 60, "h": 20, "direction": "up" },
                    { "x": 680, "y": 700, "w": 60, "h": 20, "direction": "up" },
                    { "x": 620, "y": 700, "w": 60, "h": 20, "direction": "up" },
                    { "x": 740, "y": 320, "w": 60, "h": 20, "direction": "down" },
                    { "x": 560, "y": 320, "w": 60, "h": 20, "direction": "down" },
                    { "x": 2590, "y": 360, "w": 60, "h": 20, "direction": "down" },
                    { "x": 2650, "y": 360, "w": 60, "h": 20, "direction": "down" },
                    { "x": 2570, "y": 300, "w": 60, "h": 20, "direction": "up" },
                    { "x": 2670, "y": 300, "w": 60, "h": 20, "direction": "up" },
                    { "x": 2790, "y": 570, "w": 60, "h": 20, "direction": "up" },
                    { "x": 2610, "y": 570, "w": 80, "h": 20, "direction": "up" },
                    { "x": 2300, "y": -260, "w": 800, "h": 20, "direction": "down" },
                    { "x": 2850, "y": -320, "w": 60, "h": 20, "direction": "up" },
                    { "x": 2660, "y": -320, "w": 60, "h": 20, "direction": "up" },
                    { "x": 2470, "y": -320, "w": 60, "h": 20, "direction": "up" }
                ],
                "acidPools": [],
                "lasers": [
                    { "x": 670, "y": 320, "w": 20, "h": 400, "type": "pinkLaser", "id": 486 },
                    { "x": 1930, "y": -150, "w": 20, "h": 120, "type": "yellowLaser", "id": 99 }
                ],
                "netGates": [],
                "movingPlatforms": [
                    { "startX": 1060, "startY": 500, "targetX": 1210, "targetY": 500, "w": 100, "h": 20, "speed": 0.015 },
                    { "startX": 1930, "startY": 710, "targetX": 2080, "targetY": 710, "w": 100, "h": 20, "speed": 0.015 }
                ],
                "crystals": [
                    { "x": 1460, "y": 640, "color": "#eab308" },
                    { "x": 2320, "y": 510, "color": "#eab308" },
                    { "x": 750, "y": 220, "color": "#eab308" },
                    { "x": 740, "y": 410, "color": "#eab308" },
                    { "x": 500, "y": 600, "color": "#eab308" },
                    { "x": 2160, "y": -220, "color": "#eab308" },
                    { "x": 2790, "y": -370, "color": "#eab308" },
                    { "x": 2590, "y": -370, "color": "#eab308" },
                    { "x": 3460, "y": -150, "color": "#eab308" },
                    { "x": 4170, "y": -40, "color": "#eab308" },
                    { "x": 3880, "y": 680, "color": "#eab308" },
                    { "x": 4120, "y": 660, "color": "#eab308" },
                    { "x": 4370, "y": 400, "color": "#eab308" },
                    { "x": 4340, "y": 70, "color": "#eab308" }
                ],
                "enemies": [
                    { "x": 270, "y": 650, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 680, "y": 250, "rangeX": 110, "speed": 1, "isVertical": false, "color": "#10b981", "type": "chaser" },
                    { "x": 680, "y": 200, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 1340, "y": 430, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 1190, "y": 660, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 920, "y": 420, "rangeX": 120, "speed": 1.2, "isVertical": true, "color": "#06b6d4", "type": "patrol" },
                    { "x": 2400, "y": 560, "rangeX": 120, "speed": 1.2, "isVertical": false, "color": "#f43f5e", "type": "patrol" },
                    { "x": 1970, "y": 660, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 2650, "y": 480, "rangeX": 120, "speed": 1.2, "isVertical": true, "color": "#06b6d4", "type": "patrol" },
                    { "x": 2180, "y": 610, "rangeX": 120, "speed": 1.2, "isVertical": true, "color": "#06b6d4", "type": "patrol" },
                    { "x": 3310, "y": 690, "rangeX": 120, "speed": 1.2, "isVertical": false, "color": "#f43f5e", "type": "patrol" },
                    { "x": 3050, "y": 430, "rangeX": 120, "speed": 1.2, "isVertical": true, "color": "#06b6d4", "type": "patrol" },
                    { "x": 3910, "y": 50, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 4170, "y": 50, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 4050, "y": 60, "rangeX": 150, "speed": 1, "isVertical": false, "color": "#10b981", "type": "chaser" },
                    { "x": 2980, "y": -340, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 2690, "y": -340, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" },
                    { "x": 2500, "y": -340, "rangeX": 180, "speed": 2, "isVertical": false, "color": "#eab308", "type": "patrol" }
                ],
                "pressurePlates": [],
                "pushBlocks": [],
                "conveyors": [],
                "teleportPairs": [],
                "bouncePads": [
                    { "x": 2640, "y": 300, "w": 25, "h": 20, "force": 12 }
                ],
                "buttons": [],
                "levers": [
                    { "x": 2800, "y": -10, "w": 32, "h": 32, "linkedGateId": 99 }
                ],
                "flamethrowers": [
                    {
                        "id": 9606,
                ...
                "hiddenPassages": [],
                "fallingBlockTraps": [
                    { "startX": 2530, "startY": 360, "x": 2530, "y": 360, "w": 60, "h": 60, "state": "idle", "vy": 0, "timer": 0 },
                    { "startX": 2710, "startY": 360, "x": 2710, "y": 360, "w": 60, "h": 60, "state": "idle", "vy": 0, "timer": 0 },
                    { "startX": 4010, "startY": -260, "x": 4010, "y": -260, "w": 60, "h": 60, "state": "idle", "vy": 0, "timer": 0 }
                ],
                "vantuzPoints": [],
                "decorations": [],
                "laserEmitters": [],
                ...
                "staticMirrors": [],
                "arrowShooters": [
                    { "x": 3930, "y": 370, "w": 48, "h": 48, "dir": "target", "detectionRadius": 400, "fireInterval": 1.75, "arrowSpeed": 7.5, "arrowRange": 400 },
                    { "x": 4040, "y": 370, "w": 48, "h": 48, "dir": "target", "detectionRadius": 400, "fireInterval": 1.25, "arrowSpeed": 5.5, "arrowRange": 400 }
                ]
            };
        ...
        if (data) {
            try {
                this.width = Math.min(5000, Math.max(800, data.levelWidth || data.width || 2000));
                this.height = Math.min(1500, Math.max(600, data.levelHeight || data.height || 600));
...
// ═══════════════════════════════════════════════
            ...
            // ═══════════════════════════════════════════════
            // BÖLÜM 18: ÇİFT YÖNLÜ KORİDOR — Ölümcül Dikenler
            // ═══════════════════════════════════════════════
            this.width = 1600;
            this.height = 600;
            this.spawnX = 60;
            this.spawnY = 380;
            this.portal = { x: 20, y: 120, w: 60, h: 80, angle: 0 };

            this.platforms = [
                { x: 0, y: 460, w: 1600, h: 140, type: 'normal' },
                { x: 0, y: 260, w: 1520, h: 40, type: 'normal' },
                { x: 1560, y: 340, w: 40, h: 120, type: 'sticky', sticky: true }
            ];

            this.hazards = [
                { x: 120, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 140, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 280, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 360, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 460, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 540, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 620, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 740, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 760, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 880, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 960, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 1040, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 1120, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 1200, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 1320, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' },
                { x: 1380, y: 440, w: 60, h: 20, type: 'spike', direction: 'up' },
                { x: 1440, y: 300, w: 60, h: 20, type: 'spike', direction: 'down' }
            ];

            this.enemies = [
                { x: 240, y: 380, rangeX: 120, speed: 1.2, isVertical: true, color: '#06b6d4', type: 'patrol' },
                { x: 440, y: 380, rangeX: 120, speed: 1.2, isVertical: true, color: '#06b6d4', type: 'patrol' },
                { x: 700, y: 380, rangeX: 120, speed: 1.2, isVertical: true, color: '#06b6d4', type: 'patrol' },
                { x: 940, y: 380, rangeX: 120, speed: 1.2, isVertical: true, color: '#06b6d4', type: 'patrol' },
                { x: 1200, y: 380, rangeX: 120, speed: 1.2, isVertical: true, color: '#06b6d4', type: 'patrol' },
                { x: 1320, y: 380, rangeX: 120, speed: 1.2, isVertical: true, color: '#06b6d4', type: 'patrol' },
                { x: 1440, y: 380, rangeX: 120, speed: 1.2, isVertical: true, color: '#06b6d4', type: 'patrol' },
                { x: 1120, y: 240, rangeX: 140, speed: 1.0, isVertical: false, color: '#10b981', type: 'chaser' },
                { x: 560, y: 240, rangeX: 150, speed: 1.0, isVertical: false, color: '#10b981', type: 'chaser' },
                { x: 880, y: 240, rangeX: 100, speed: 1.2, isVertical: false, color: '#f43f5e', type: 'patrol' },
                { x: 280, y: 240, rangeX: 120, speed: 1.2, isVertical: false, color: '#f43f5e', type: 'patrol' },
                { x: 1400, y: 240, rangeX: 120, speed: 1.2, isVertical: false, color: '#f43f5e', type: 'patrol' }
            ];

            this.fallingBlockTraps = [
                { startX: 380, startY: 0, x: 380, y: 0, w: 60, h: 60, state: 'idle', vy: 0, timer: 0 },
                { startX: 1000, startY: 0, x: 1000, y: 0, w: 60, h: 60, state: 'idle', vy: 0, timer: 0 },
                { startX: 700, startY: 0, x: 700, y: 0, w: 60, h: 60, state: 'idle', vy: 0, timer: 0 }
            ];

            this.arrowShooters = [
                { x: 620, y: -80, w: 48, h: 48, dir: 'target', detectionRadius: 700, fireInterval: 2.5, arrowSpeed: 15.0, arrowRange: 500, fireTimer: 0, arrows: [] }
            ];

            this.collectibles = [
                { x: 480, y: 380, color: '#eab308' },
                { x: 1510, y: 340, color: '#eab308' },
                { x: 700, y: 200, color: '#eab308' }
            ];
        ...
        if (originalLevelNumber > 20 && originalLevelNumber <= 30) {
            ...
            if (!baseName) {
                const names = {
                    21: "SİBER GİRİŞİ",
                    22: "MİKROÇİP LABİRENTİ",
                    23: "PORTAL BAĞLANTISI",
                    24: "KRONO TETİKLEYİCİ",
                    25: "YERÇEKİMİ BOŞLUĞU",
                    26: "KARA DÜŞMAN ALANI",
                    27: "LAZER KAFESİ",
                    28: "KOD DEPOSU",
            ...
            baseName = baseName.replace(/^SİBER VERİ AKIŞI:\s*/, "");
    ...
    resetLevelRuntimeState(isCheckpointRespawn = false) {
        ...
        if (this.collectibles) {
            this.collectibles = this.collectibles.filter(c => !c.enemyDropped);
            this.collectibles.forEach(c => {

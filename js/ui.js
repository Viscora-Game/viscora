...
import { ViscosityList } from './viscosity.js?v=v276';
import { shopManager, SHOP_ITEMS } from './shop.js?v=v276';
import { CloudSaveManager } from './cloud_save.js?v=v276';
    ...
    initProfileUI() {
        ...
        if (avatarPicker) {
            ...
            this.profileAvatars.forEach(av => {
                ...
                img.src = `assets/avatars/${av.id}.png?v=v276`;
        ...
        const updateWidget = () => {
            ...
            if (widgetAvatar) {
                widgetAvatar.src = `assets/avatars/${currentAvatar}.png?v=v276`;
            }
        };

...
import { ViscosityList } from './viscosity.js?v=v305';
import { shopManager, SHOP_ITEMS } from './shop.js?v=v305';
import { CloudSaveManager } from './cloud_save.js?v=v305';
    ...
    initProfileUI() {
        ...
        if (avatarPicker) {
            ...
            this.profileAvatars.forEach(av => {
                ...
                img.src = `assets/avatars/${av.id}.png?v=v305`;
        ...
        const updateWidget = () => {
            ...
            if (widgetAvatar) {
                widgetAvatar.src = `assets/avatars/${currentAvatar}.png?v=v305`;
            }
        };

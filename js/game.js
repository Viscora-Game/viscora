import { Player } from './player.js?v=v307';
import { Level } from './level.js?v=v307';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v307';
import { UIManager } from './ui.js?v=v307';
import { CloudSaveManager } from './cloud_save.js?v=v307';
import { audio } from './audio.js?v=v307';
import { LevelEditor } from './editor.js?v=v307';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v307';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v307', this.cssWidth - 10, 10);

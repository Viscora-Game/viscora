import { Player } from './player.js?v=v310';
import { Level } from './level.js?v=v310';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v310';
import { UIManager } from './ui.js?v=v310';
import { CloudSaveManager } from './cloud_save.js?v=v310';
import { audio } from './audio.js?v=v310';
import { LevelEditor } from './editor.js?v=v310';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v310';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v310', this.cssWidth - 10, 10);

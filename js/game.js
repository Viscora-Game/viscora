import { Player } from './player.js?v=v300';
import { Level } from './level.js?v=v300';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v300';
import { UIManager } from './ui.js?v=v300';
import { CloudSaveManager } from './cloud_save.js?v=v300';
import { audio } from './audio.js?v=v300';
import { LevelEditor } from './editor.js?v=v300';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v300';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v300', this.cssWidth - 10, 10);

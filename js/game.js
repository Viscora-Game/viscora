import { Player } from './player.js?v=v322';
import { Level } from './level.js?v=v322';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v322';
import { UIManager } from './ui.js?v=v322';
import { CloudSaveManager } from './cloud_save.js?v=v322';
import { audio } from './audio.js?v=v322';
import { LevelEditor } from './editor.js?v=v322';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v322';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v322', this.cssWidth - 10, 10);

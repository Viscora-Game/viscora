import { Player } from './player.js?v=v101';
import { Level } from './level.js?v=v101';
import { Enemy, GelChaser } from './enemies.js?v=v101';
import { UIManager } from './ui.js?v=v101';
import { audio } from './audio.js?v=v101';
import { LevelEditor } from './editor.js?v=v101';
import { Boss, CyberBoss } from './boss.js?v=v101';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v101', this.cssWidth - 10, 10);

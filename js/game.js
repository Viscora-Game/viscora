import { Player } from './player.js?v=v328';
import { Level } from './level.js?v=v328';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v328';
import { UIManager } from './ui.js?v=v328';
import { CloudSaveManager } from './cloud_save.js?v=v328';
import { audio } from './audio.js?v=v328';
import { LevelEditor } from './editor.js?v=v328';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v328';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v328', this.cssWidth - 10, 10);

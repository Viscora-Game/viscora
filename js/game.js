import { Player } from './player.js?v=v319';
import { Level } from './level.js?v=v319';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v319';
import { UIManager } from './ui.js?v=v319';
import { CloudSaveManager } from './cloud_save.js?v=v319';
import { audio } from './audio.js?v=v319';
import { LevelEditor } from './editor.js?v=v319';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v319';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v319', this.cssWidth - 10, 10);

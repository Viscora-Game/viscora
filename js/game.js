import { Player } from './player.js?v=v309';
import { Level } from './level.js?v=v309';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v309';
import { UIManager } from './ui.js?v=v309';
import { CloudSaveManager } from './cloud_save.js?v=v309';
import { audio } from './audio.js?v=v309';
import { LevelEditor } from './editor.js?v=v309';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v309';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v309', this.cssWidth - 10, 10);

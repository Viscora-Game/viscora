import { Player } from './player.js?v=v323';
import { Level } from './level.js?v=v323';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v323';
import { UIManager } from './ui.js?v=v323';
import { CloudSaveManager } from './cloud_save.js?v=v323';
import { audio } from './audio.js?v=v323';
import { LevelEditor } from './editor.js?v=v323';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v323';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v323', this.cssWidth - 10, 10);

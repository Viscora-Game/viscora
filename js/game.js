import { Player } from './player.js?v=v304';
import { Level } from './level.js?v=v304';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v304';
import { UIManager } from './ui.js?v=v304';
import { CloudSaveManager } from './cloud_save.js?v=v304';
import { audio } from './audio.js?v=v304';
import { LevelEditor } from './editor.js?v=v304';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v304';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v304', this.cssWidth - 10, 10);

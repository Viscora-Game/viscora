import { Player } from './player.js?v=v313';
import { Level } from './level.js?v=v313';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v313';
import { UIManager } from './ui.js?v=v313';
import { CloudSaveManager } from './cloud_save.js?v=v313';
import { audio } from './audio.js?v=v313';
import { LevelEditor } from './editor.js?v=v313';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v313';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v313', this.cssWidth - 10, 10);

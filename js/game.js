import { Player } from './player.js?v=v301';
import { Level } from './level.js?v=v301';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v301';
import { UIManager } from './ui.js?v=v301';
import { CloudSaveManager } from './cloud_save.js?v=v301';
import { audio } from './audio.js?v=v301';
import { LevelEditor } from './editor.js?v=v301';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v301';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v301', this.cssWidth - 10, 10);

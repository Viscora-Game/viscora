import { Player } from './player.js?v=v308';
import { Level } from './level.js?v=v308';
import { Enemy, GelChaser, TractorUFO, SweeperUFO } from './enemies.js?v=v308';
import { UIManager } from './ui.js?v=v308';
import { CloudSaveManager } from './cloud_save.js?v=v308';
import { audio } from './audio.js?v=v308';
import { LevelEditor } from './editor.js?v=v308';
import { Boss, CyberBoss, UfoBoss } from './boss.js?v=v308';
...
export class GameManager {
    ...
    draw() {
        ...
        this.ctx.fillText('v308', this.cssWidth - 10, 10);
